...
('Elden Ring','Dodges', 59.00, 'Hellish Image', 20, 2000, '4321', '2023-01-01', 'MATURE_17', 2, 1, 5),                                   -- 2
('Playstation 5', 'Even contains a controller', 359.00, 'wow', 20, 1000000, 'abcdSony', '2020-05-05', 'NO_RATING', 2, 2, 2),          -- 3
('Sonic Shirt', 'Cool shirt with sonic print', 12.99, 'Gotta go fast.png', 15, 5, 'dafgjnkig', '1990-1-1', 'NO_RATING', NULL, 3, 4),         -- 4
('20€ Giftcard', 'Not worth buying', 30.00, 'lololol', 10, 1, '1337', '2020-01-20', 'NO_RATING', NULL, 5, 10),                               -- 5
('Xbox Headset', 'Headset Xbox', 49.99, 'headset.jpeg', 25, 100, 'a', '2023-01-01', 'NO_RATING', 1, 4, 3),                                   -- 6
('Gameverse', 'Buy us, we are on sale', 3000000.01, 'company.bmp', 30, 1, 'wow', '2012-01-01', 'NO_RATING', NULL, 6, 10);                    -- 7
